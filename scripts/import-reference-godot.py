...
the Godot build — and writes godot/scripts/data/ReferenceCatalog.gd, a
script exposing two const Arrays the Collection screen renders. Mirrors the
other scripts/import-*-godot.py importers (data lives in the sheet, code is
...
OUT_PATH = os.path.join(PROJECT_ROOT, "godot", "scripts", "data", "ReferenceCatalog.gd")
STATUS_ICON_DIR = os.path.join(PROJECT_ROOT, "godot", "images", "statuses")
