...
# (The EncounterNode / EncounterModal overworld UI was cut with the old
# overworld in §11; the shop-stock persistence test that drove them is dropped.
# EncounterData itself is kept and covered by the data-layer tests above.)
