...
window.amuletGame = amuletGame;
window.amuletImageUrl = amuletImageUrl;
window.amuletMarker = amuletMarker;
window.attack = attack;
window.beatenGames = beatenGames;
window.bingoCompleted = bingoCompleted;
window.bingoDash = bingoDash;
window.bingoDiscovery = bingoDiscovery;
window.bingoFoV = bingoFoV;
window.bingoGoals = bingoGoals;
window.bingoGrid = bingoGrid;
window.bingoReroll = bingoReroll;
window.bingoSkip = bingoSkip;
window.cards = cards;
window.charisma = charisma;
window.completedBingos = completedBingos;
window.currentEnemy = currentEnemy;
window.currentRoll = currentRoll;
window.curses = curses;
window.dash = dash;
window.debugMode = debugMode;
window.dexterity = dexterity;
window.discovery = discovery;
window.encounterHistory = encounterHistory;
window.enemies = enemies;
window.events = events;
window.excludedGames = excludedGames;
window.fov = fov;
window.gameSaves = gameSaves;
